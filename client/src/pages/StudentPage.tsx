    ...
    return(
        <div>
            ...
            <div className="relative h-[100vh] bg-[#F0F0F0]" >
                ...
                >
                    <a className="w-full h-[100%] top-0 left-0 absolute bg-black opacity-50 z-[1] duration-200 transform delay-600" onClick={() => setIsOpenModal(false)}></a>
                    {/*TODO: Form data*/}
                </div>
                <AnimatedPage>
...
const ColumnData: React.FC = () => {
    ...
    return(
        <AnimatedPage>
            <div className={listStudent?.length >= 7 ? "pt-5 h-[80vh] w-[97%] overflow-y-scroll z-0" : "mt-10 w-[97%] overflow-y-scroll z-0"}>
                {
                    listStudent ? listStudent.map((student: Student, index: number) => (
                        <div key={index} className="ColumnData flex mt-1 mb-5 mx-10 px-10">
                            ...
                            <div className="list-data grid grid-cols-12 gap-x-2 bg-white rounded-full w-full px-1 items-center justify-around shadow-xl">
                                ...
                                <div className="col-span-3 edit flex justify-around items-center">
                                    <BiEdit className="text-xl fill-green-600 cursor-pointer hover:scale-125 duration-150" />
                                    <MdOutlineDeleteOutline className="text-xl fill-red-600 cursor-pointer hover:scale-125 duration-150" />
                                </div>
                            </div>
                        </div>
                    )) : (
